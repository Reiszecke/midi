...
//            Log.d("MIDISession", "note:" + note + " velocity:" + velocity);
    ...
    public long getNow() {
      ...
      //  long result = Math.round((hrtime / 1000L / 1000L / 1000L) * this.rate) ;
        ...
        I HAVE ABSOLUTELY NO IDEA WHAT DisappointedPig ORIGINALLY DID THERE.
        Somehow the sending of messages would be very very laggy. I don't know
        if I broke something else now but doing
        ...
        seemed to have done the trick at least for me.
        ...
        long result = Math.round((hrtime / 1000L / 1000L / 1000L) * this.rate) ;
     //   long result = Math.round((hrtime / 1000L / 1000L) * this.rate) ;
